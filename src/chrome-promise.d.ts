...
export default class ChromePromise {
  constructor(options?: { chrome?: object; Promise?: Function })
...
declare namespace chromepApi.accessibilityFeatures {
  export interface AccessibilityFeaturesSetting {
    ...
    get(
      ...
      chrome.accessibilityFeatures.AccessibilityFeaturesCallbackArg
    >
    /**
...
declare namespace chromepApi.browserAction {
  ...
  export interface BrowserAction {
    ...
    getBadgeBackgroundColor(
      details: chrome.browserAction.TabDetails,
    ): Promise<chrome.browserAction.ColorArray>
    /**
     * Since Chrome 19.
...
declare namespace chromepApi.contentSettings {
  export interface CookieContentSetting
    extends chrome.contentSettings.ContentSetting {
    set(
      details: chrome.contentSettings.CookieSetDetails,
    ): Promise<void>
  }
  export interface PopupsContentSetting
    extends chrome.contentSettings.ContentSetting {
    set(
  ...
  export interface PluginsContentSetting
    extends chrome.contentSettings.ContentSetting {
    set(
      details: chrome.contentSettings.PluginsSetDetails,
    ): Promise<void>
  }
  export interface ImagesContentSetting
    extends chrome.contentSettings.ContentSetting {
    set(
  ...
  export interface CameraContentSetting
    extends chrome.contentSettings.ContentSetting {
    set(
...
declare namespace chromepApi.declarativeWebRequest {
  export interface RequestedEvent
    extends chrome.events.Event<Function> {}
...
declare namespace chromepApi.documentScan {
  export interface DocumentScan {
    ...
    ): Promise<chrome.documentScan.DocumentScanCallbackArg>
  }
}
  ...
  export interface DownloadDeterminingFilenameEvent
    extends chrome.events.Event<
      (
        ...
        suggest: (
          suggestion?: chrome.downloads.DownloadFilenameSuggestion,
        ) => void,
      ) => void
    > {}
...
declare namespace chromepApi.fileBrowserHandler {
  ...
  export interface FileBrowserHandler {
    ...
    ): Promise<chrome.fileBrowserHandler.SelectionResult>
...
declare namespace chromepApi.fileSystemProvider {
  ...
  export interface FileSystemProvider {
    ...
    get(
      fileSystemId: string,
    ): Promise<chrome.fileSystemProvider.FileSystemInfo>
    /**
...
declare namespace chromepApi.fontSettings {
  ...
  export interface FontSettings {
    ...
    ): Promise<chrome.fontSettings.FontDetailsResult>
    /**
    ...
    getDefaultFontSize(
      details?: Object,
    ): Promise<chrome.fontSettings.FontSizeDetails>
    /**
...
declare namespace chromepApi.idle {
  export interface IdleStateChangedEvent
    extends chrome.events.Event<(newState: string) => void> {}
...
declare namespace chromepApi.management {
  ...
  export interface Management {
    ...
    generateAppForLink(
      url: string,
      title: string,
    ): Promise<chrome.management.ExtensionInfo>
  ...
  export interface OmniboxInputChangedEvent
    extends chrome.events.Event<
      (
        text: string,
        suggest: (
          suggestResults: chrome.omnibox.SuggestResult[],
        ) => void,
      ) => void
    > {}
...
declare namespace chromepApi.platformKeys {
  export interface PlatformKeys {
    ...
    ): Promise<chrome.platformKeys.Match[]>
    /**
    ...
    getKeyPair(
      ...
      parameters: Object,
    ): Promise<[CryptoKey, CryptoKey | null]>
    /**
    ...
    verifyTLSServerCertificate(
      ...
      chrome.platformKeys.ServerCertificateVerificationResult
    >
  }
}
...
declare namespace chromepApi.runtime {
  ...
  export interface Runtime {
     ...
     */
    requestUpdateCheck(): Promise<[string]>
    requestUpdateCheck(): Promise<
      [string, chrome.runtime.UpdateCheckDetails]
    >
    /**
...
declare namespace chromepApi.socket {
  export interface Socket {
    create(
      type: string,
      options?: Object,
    ): Promise<chrome.socket.CreateInfo>
    connect(
      socketId: number,
      hostname: string,
      port: number,
    ...
    read(
      socketId: number,
      bufferSize?: number,
    ): Promise<chrome.socket.ReadInfo>
    write(
      socketId: number,
      data: ArrayBuffer,
    ): Promise<chrome.socket.WriteInfo>
    recvFrom(
      socketId: number,
      bufferSize?: number,
    ): Promise<chrome.socket.RecvFromInfo>
    sendTo(
      socketId: number,
      data: ArrayBuffer,
      address: string,
...
declare namespace chromepApi.system.memory {
  ...
  export function getInfo(): Promise<
    chrome.system.memory.MemoryInfo
  >
}
declare namespace chromepApi.system.storage {
  ...
  export function getAvailableCapacity(
    id: string,
  ): Promise<chrome.system.storage.StorageCapacityInfo>
}
...
declare namespace chromepApi.tabs {
  ...
  export interface TabSelectedEvent
    extends chrome.events.Event<
      (
        tabId: number,
        selectInfo: chrome.tabs.TabWindowInfo,
      ) => void
    > {}
